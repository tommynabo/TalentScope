...
const TalentPoolView: React.FC = () => {
  return (
    <div className="w-full h-full flex flex-col items-center justify-center text-center p-8 animate-in fade-in zoom-in duration-500 min-h-[80vh]">
      ...
      <h1 className="text-4xl font-bold text-slate-500 mb-3">Módulo de Talento Bloqueado</h1>
