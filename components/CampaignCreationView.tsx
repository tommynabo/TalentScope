        ...
        <div className="p-3 md:p-4 lg:p-6 animate-in slide-in-from-right duration-300">
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-3 mb-5 md:mb-6">
                ...
                <div className="flex-1">
                    <h1 className="text-lg md:text-xl lg:text-2xl font-bold text-white tracking-tight">New Campaign</h1>
                    <p className="text-slate-400 text-xs md:text-sm">Configure search parameters and "A-Player" signals.</p>
                </div>
                <button
